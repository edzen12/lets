...
if ( class_exists( 'All_in_One_SEO_Pack_Sitemap' ) && ( ! class_exists( 'All_in_One_SEO_Pack_Video_Sitemap' ) ) ) {
	class All_in_One_SEO_Pack_Video_Sitemap extends All_in_One_SEO_Pack_Sitemap {
		...
		private function filter_unused_settings() {
			unset( $this->layout['default']['options'][4] ); // Unset Taxonomies.
			unset( $this->layout['default']['options'][5] ); // Unset Include Date Archives.
			unset( $this->layout['default']['options'][6] ); // Unset Include Author Pages.
			unset( $this->layout['default']['options'][7] ); // Unset Exclude Images.
			unset( $this->layout['addl_sitemaps'] );
			unset( $this->layout['excl_pages']['options'][0] ); // Unset Exclude Terms.
