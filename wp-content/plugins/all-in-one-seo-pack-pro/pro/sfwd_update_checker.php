...
$aioseop_options['aiosp_license_key'] = 'MT-AAAAAAAAAAAAAA';
$aioseop_options['addons'] = [ 'image_seo', 'schema_local_business' ];
...
class SFWD_Update_Checker extends PluginUpdateChecker_3_1 {
	...
	function key_warning() {
		$msg = '';
		$license_key = null;
		if ( ! empty( $_POST ) && ( ! empty( $_POST['aiosp_license_key'] ) ) ) {
			$license_key = $_POST['aiosp_license_key'];
		}
